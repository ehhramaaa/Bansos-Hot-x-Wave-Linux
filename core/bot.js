...
async function hotWallet(page, threshold) {
    ...
    // Get Near Balance
    const nearBalance1 = await iframeGetText('#root > div > div > div.sc-ifyrTC.kehHNg > div > div > div:nth-child(6) > div:nth-child(2) > div.sc-drnuxz.gogwPM > div:nth-child(3) > p.sc-gnpbhQ.exwOjV', iframe)

    console.log(nearBalance1)
    
    // Get Near Balance
    const nearBalance = parseFloat(await iframeGetText('#root > div > div > div.sc-ifyrTC.kehHNg > div > div > div:nth-child(6) > div:nth-child(2) > div.sc-drnuxz.gogwPM > div:nth-child(3) > p.sc-gnpbhQ.exwOjV', iframe))
